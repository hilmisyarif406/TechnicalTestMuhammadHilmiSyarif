...
import com.example.techtaskhilmi.databinding.ActivityTimeConvBinding

class TimeConvActivity : AppCompatActivity() {
    private lateinit var binding: ActivityTimeConvBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTimeConvBinding.inflate(layoutInflater)
